...
#if defined(_EXPORTED_ENABLE_FEATHER) || defined(_EXPORTED_ATLAS_BLIT)
...
#ifdef _EXPORTED_ATLAS_TEXTURE_R32UI_FLOAT_BITS
TEXTURE_R32UI(PER_FLUSH_BINDINGS_SET, ATLAS_TEXTURE_IDX, _EXPORTED_atlasTexture);
#elif defined(_EXPORTED_ATLAS_TEXTURE_R32I_FIXED_POINT)
TEXTURE_R32I(PER_FLUSH_BINDINGS_SET, ATLAS_TEXTURE_IDX, _EXPORTED_atlasTexture);
#elif defined(_EXPORTED_ATLAS_TEXTURE_RGBA8_UNORM)
TEXTURE_RGBA8(PER_FLUSH_BINDINGS_SET, ATLAS_TEXTURE_IDX, _EXPORTED_atlasTexture);
#else
TEXTURE_R16F(PER_FLUSH_BINDINGS_SET, ATLAS_TEXTURE_IDX, _EXPORTED_atlasTexture);
#endif
#endif
...
// clang-format off
#if defined(_EXPORTED_RENDER_MODE_MSAA) && defined(_EXPORTED_ENABLE_ADVANCED_BLEND) && !defined(_EXPORTED_FIXED_FUNCTION_COLOR_OUTPUT)
// clang-format on
...
#if defined(_EXPORTED_FRAGMENT) && defined(_EXPORTED_ENABLE_FEATHER)
...
#if defined(_EXPORTED_FRAGMENT) && defined(_EXPORTED_ATLAS_BLIT)
                     ...
                     float2 atlasTextureInverseSize TEXTURE_CONTEXT_DECL)
{
    ...
    half4 coverages;
#ifdef _EXPORTED_ATLAS_TEXTURE_R32UI_FLOAT_BITS
    coverages = uintBitsToFloat(uint4(TEXTURE_GATHER(_EXPORTED_atlasTexture,
                                                     atlasSampler,
                                                     atlasQuadCenter,
                                                     atlasTextureInverseSize)));
#elif defined(_EXPORTED_ATLAS_TEXTURE_R32I_FIXED_POINT)
    int4 coverages_i32 = int4(TEXTURE_GATHER(_EXPORTED_atlasTexture,
                                             atlasSampler,
                                             atlasQuadCenter,
                                             atlasTextureInverseSize));
    ...
    half4x4 coverages_u8x4 =
        make_half4x4(TEXTURE_GATHER_MATRIX(_EXPORTED_atlasTexture, coord, .xyzw));
    ...
    coverages = make_half4(ATLAS_UNORM8_COVERAGE_SCALE_FACTOR,
                ...
                coverages_u8x4;
#else
    coverages = make_half4(TEXTURE_GATHER(_EXPORTED_atlasTexture,
                                          atlasSampler,
                                          atlasQuadCenter,
                                          atlasTextureInverseSize));
#endif
...
#if defined(_EXPORTED_VERTEX) && defined(_EXPORTED_DRAW_PATH)
                                               ...
                                               VERTEX_CONTEXT_DECL)
{
    ...
    uint4 contourData = STORAGE_BUFFER_LOAD4(_EXPORTED_contourBuffer, contourID - 1u);
    ...
    if (localVertexID != vertexIDOnContour)
    {
            ...
            (contourIDWithFlags & (MIRRORED_CONTOUR_CONTOUR_FLAG | 0xffffu)))
        {
            ...
            if (isClosed)
            {
                ...
                tessVertexData = TEXEL_FETCH(_EXPORTED_tessVertexTexture,
...
#if defined(_EXPORTED_VERTEX) && defined(_EXPORTED_DRAW_INTERIOR_TRIANGLES)
...
#if defined(_EXPORTED_VERTEX) && defined(_EXPORTED_ATLAS_BLIT)
INLINE float2
