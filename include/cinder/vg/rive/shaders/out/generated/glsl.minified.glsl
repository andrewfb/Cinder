...
#if (GLSL_VERSION >= 310 && GLSL_VERSION < 400) || GLSL_VERSION >= 420
#define GLSL_HAS_EXPLICIT_BINDINGS  1
#endif
...
#if GLSL_VERSION >= 400 && GLSL_VERSION < 420
...
#ifdef GLSL_HAS_EXPLICIT_BINDINGS
...
#elif defined(GLSL_HAS_EXPLICIT_BINDINGS)
#define TEXTURE_RGBA32UI(SET, IDX, NAME)                                        \
