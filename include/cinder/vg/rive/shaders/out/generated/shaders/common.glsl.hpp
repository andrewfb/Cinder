...
{
#if defined(_EXPORTED_GL_RENDERER_MALI) || defined(_EXPORTED_VULKAN_VENDOR_ID)
...
#ifndef _EXPORTED_DISABLE_CLIP_DISTANCE_FOR_UBERSHADERS
...
// clang-format off
#if defined(_EXPORTED_FRAGMENT) && defined(_EXPORTED_RENDER_MODE_MSAA) && !defined(_EXPORTED_FIXED_FUNCTION_COLOR_OUTPUT)
// clang-format on
