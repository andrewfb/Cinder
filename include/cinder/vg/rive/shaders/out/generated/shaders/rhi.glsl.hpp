...
#ifdef _EXPORTED_NEEDS_CLIP_DISTANCE
...
#ifdef _EXPORTED_SUPPORTS_SUBPASS_LOAD
...
#if defined(_EXPORTED_FIXED_FUNCTION_COLOR_OUTPUT) && defined(_EXPORTED_DRAW_IMAGE_MESH)
