...
if( NOT CINDER_DISABLE_VECTOR_GRAPHICS )
	...
	# Rive renderer sources (core, math, renderer, GL backend)
	# GLES-only files excluded: load_gles_extensions.cpp, pls_impl_ext_native.cpp
	list( APPEND SRC_SET_RIVE
	...
	list( APPEND CINDER_SRC_FILES ${SRC_SET_CINDER_VG} ${SRC_SET_RIVE} )
	source_group( "cinder\\vg" FILES ${SRC_SET_CINDER_VG} )
	source_group( "thirdparty\\rive" FILES ${SRC_SET_RIVE} )
