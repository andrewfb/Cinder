/*
 Demo base class for VectorGraphics demo framework

 Each demo showcases different features of the vg::CanvasGl API.
*/
#pragma once
...
public:
    ...
    virtual void setup( vg::CanvasGlRef canvas ) {}
    ...
    virtual void draw( vg::CanvasGlRef canvas ) = 0;
